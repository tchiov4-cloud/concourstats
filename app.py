...
with central_column:
    ...
    # Affichage final sans le curseur clignotant
    placeholder.markdown(
        f"<div style='text-align: center; max-width: 650px; margin: 0 auto 20px auto;'>"
        f"<p style='font-style: italic; color: #555; line-height: 1.5; font-size: 1.05em;'>"
    ...
    with tab2:
        ...
        except Exception as e: st.error(f"Erreur de connexion : {e}")import streamlit as st
import pandas as pd
import plotly.express as px
import mysql.connector
import time
